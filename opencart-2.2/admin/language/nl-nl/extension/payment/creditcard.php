<?php
// Heading
$_['heading_title']      = 'Creditcard Visa/Mastercard (TargetPay)';

// Text
$_['text_payment']       = 'Betaling';
$_['text_success']       = 'Gelukt: de TargetPay instellingen zijn gewijzigd!';
$_['text_edit']          = 'Bewerk TargetPay ' . $_['heading_title'];
$_['text_creditcard']    = '<a href="https://www.targetpay.com/signup?p_actiecode=YM3R2A" target="_blank"><img src="view/image/payment/visamc.png" alt="Visa/Mastercard via TargetPay" title="Visa/Mastercard via TargetPay" style="border: none;" /></a>';
