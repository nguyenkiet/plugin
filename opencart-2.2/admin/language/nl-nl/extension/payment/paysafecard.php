<?php
// Heading
$_['heading_title']      = 'Paysafecard (TargetPay)';

// Text
$_['text_payment']       = 'Betaling';
$_['text_success']       = 'Gelukt: de TargetPay instellingen zijn gewijzigd!';
$_['text_edit']          = 'Bewerk TargetPay ' . $_['heading_title'];
$_['text_paysafecard']   = '<a href="https://www.targetpay.com/signup?p_actiecode=YM3R2A" target="_blank"><img src="view/image/payment/paysafecard.png" alt="Paysafecard via TargetPay" title="Paysafecard via TargetPay" style="border: none;" /></a>';
