<?php
// Heading
$_['heading_title']      = 'Mister Cash (TargetPay)';

// Text
$_['text_payment']       = 'Betaling';
$_['text_success']       = 'Gelukt: de TargetPay instellingen zijn gewijzigd!';
$_['text_edit']          = 'Bewerk TargetPay ' . $_['heading_title'];
$_['text_mrcash']     	 = '<a href="https://www.targetpay.com/signup?p_actiecode=YM3R2A" target="_blank"><img src="view/image/payment/mrcash.png" alt="Bancontact/Mister Cash via TargetPay" title="Bancontact/Mister Cash via TargetPay" style="border: none;" /></a>';
