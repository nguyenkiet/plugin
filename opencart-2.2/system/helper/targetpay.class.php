    ...
    */
    ...
    public function startPayment()
    {
        ...
        $url = "https://www.targetpay.com/api/idealplugins?" .
            ...
            (($this->payMethod == "MRC") ? "lang=" . urlencode($this->getLanguage(array("NL", "FR", "EN"),
                    "NL")) . "&" : "") .
            (($this->payMethod == "DEB") ? "type=1&country=" . urlencode($this->countryId) . "&lang=" . urlencode($this->getLanguage(array(
                    "NL",
                    "EN",
                    "DE"
                ), "DE")) . "&" : "") .
